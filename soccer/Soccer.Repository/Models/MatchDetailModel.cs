namespace Soccer.Models
{
    public class MatchDetailModel
    {
        ...
        public MatchDetailModel(string id, string firstHalf_H, string firstHalf_A, string secondHalf_H, string secondHalf_A, string regularTime_H, string regularTime_A, string corners_H, string corners_A, string penalties_H, string penalties_A,
