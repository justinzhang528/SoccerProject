...
namespace ConsoleApplication
{
    class Program
    {
        public static void ParseHtml(string data, List<Result> results)
        {
            {
                ...
                while(idx < rows.Count)
                {
                    ...
                    Result result = new Result(gameTime, leagues, events, events, homeScore, awayScore, status, detail);             
                    results.Add(result);
                }                
            }
        }
        ...
        public static string GetHtmlContentFromNet(string url)
        {
        ...
        {
            string strHTML = GetHtmlContentFromNet("https://bti-results.bsportsasia.com/?ns=prod20082-23705321.bti-sports.io&locale=en&tzoffset=8");
